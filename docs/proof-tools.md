...
Four tables are too large to reproduce here — `editor-check` declares 207, `library-check` 178,
...
178 controls, listed by `node tools/library-check.mjs --mutate __enumerate__`.
