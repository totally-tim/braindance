...
Four tables are too large to reproduce here — `editor-check` declares 202, `library-check` 138,
...
138 controls, listed by `node tools/library-check.mjs --mutate __enumerate__`.
